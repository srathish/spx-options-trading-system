"""
Regime Engine v4 — King-Persistence + AT_SPOT Continuation + Chop Override

Fixes from v3:
A. AT_SPOT continuation: if king is AT_SPOT but thesis is active and
   same-direction targets are building, CONTINUE thesis (don't NO_TRADE)
B. Chop override: high flip_count forces STRADDLE or NO_TRADE,
   zeroes out directional scores on chop days (Feb 11 fix)
...
if __name__ == '__main__':
    ...
    v3_df.to_csv('research/regime_v4.csv', index=False)
